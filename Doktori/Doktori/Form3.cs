...
namespace Doktori
{
    public partial class Form3 : Form
    {
        ...
        {
            this.Validate();
            this.dijagnozaBindingSource.EndEdit();
        ...
        {
            // TODO: This line of code loads data into the 'lijecnikDataSet.Dijagnoza' table. You can move, or remove it, as needed.
            this.dijagnozaTableAdapter.Fill(this.lijecnikDataSet.Dijagnoza);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (SqlConnection connection = new SqlConnection(@"Data Source=ANT-HOH\SQLEXPRESS01;Initial Catalog=Lijecnik;Integrated Security=True"))
            {
                ...
                da.Fill(table);
                dijagnozaDataGridView.DataSource = table;

                // Resize the DataGridView columns to fit the newly loaded content.
                dijagnozaDataGridView.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
